...
public class QLayout_4_0_8_Object extends org.datanucleus.api.jdo.query.PersistableExpressionImpl<Layout_4_0_8_Object> implements PersistableExpression<Layout_4_0_8_Object>
{
    public static final QLayout_4_0_8_Object jdoCandidate = candidate("this");

    public static QLayout_4_0_8_Object candidate(String name)
    {
        return new QLayout_4_0_8_Object(null, name, 5);
    }

    public static QLayout_4_0_8_Object candidate()
    {
        return jdoCandidate;
    }

    public static QLayout_4_0_8_Object parameter(String name)
    {
        return new QLayout_4_0_8_Object(Layout_4_0_8_Object.class, name, ExpressionType.PARAMETER);
    }

    public static QLayout_4_0_8_Object variable(String name)
    {
        return new QLayout_4_0_8_Object(Layout_4_0_8_Object.class, name, ExpressionType.VARIABLE);
    }
    ...
    public QLayout_4_0_8_Object(PersistableExpression parent, String name, int depth)
    {
        super(parent, name);
    ...
    public QLayout_4_0_8_Object(Class type, String name, org.datanucleus.api.jdo.query.ExpressionType exprType)
    {
