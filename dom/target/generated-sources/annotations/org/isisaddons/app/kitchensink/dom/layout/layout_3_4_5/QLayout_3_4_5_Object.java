...
public class QLayout_3_4_5_Object extends org.datanucleus.api.jdo.query.PersistableExpressionImpl<Layout_3_4_5_Object> implements PersistableExpression<Layout_3_4_5_Object>
{
    public static final QLayout_3_4_5_Object jdoCandidate = candidate("this");

    public static QLayout_3_4_5_Object candidate(String name)
    {
        return new QLayout_3_4_5_Object(null, name, 5);
    }

    public static QLayout_3_4_5_Object candidate()
    {
        return jdoCandidate;
    }

    public static QLayout_3_4_5_Object parameter(String name)
    {
        return new QLayout_3_4_5_Object(Layout_3_4_5_Object.class, name, ExpressionType.PARAMETER);
    }

    public static QLayout_3_4_5_Object variable(String name)
    {
        return new QLayout_3_4_5_Object(Layout_3_4_5_Object.class, name, ExpressionType.VARIABLE);
    }
    ...
    public QLayout_3_4_5_Object(PersistableExpression parent, String name, int depth)
    {
        super(parent, name);
    ...
    public QLayout_3_4_5_Object(Class type, String name, org.datanucleus.api.jdo.query.ExpressionType exprType)
    {
